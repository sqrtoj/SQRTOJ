...
class ProblemTranslationForm(ModelForm):
    class Meta:
        ...
        fields = ('language', 'name', 'description', 'sample_input', 'sample_output')
        widgets = {
            'description': AdminMartorWidget(attrs={'data-markdownfy-url': reverse_lazy('problem_preview')}),
            'sample_input': AdminMartorWidget(attrs={'data-markdownfy-url': reverse_lazy('problem_preview')}),
            'sample_output': AdminMartorWidget(attrs={'data-markdownfy-url': reverse_lazy('problem_preview')}),
        }
