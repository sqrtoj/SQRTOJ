...
As a fork of [DMOJ](https://github.com/DMOJ/online-judge) and [VNOJ](https://github.com/VNOI-Admin/OJ), SQRTOJ serves as [SQRT](https://sqrtoj.edu.vn)'s official online judge and hosts its programming contests.

See it live at [sqrtoj.edu.vn](https://sqrtoj.edu.vn/)!
...
- Regarding disabling full-text search, please read [this issue](hxttps://github.com/VNOI-Admin/OJ/issues/4) for more information.
