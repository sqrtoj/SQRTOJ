...
SECRET_KEY = 'change-me-in-local_settings'
...
MIDDLEWARE = (
    ...
    'judge.middleware.MaintenanceModeMiddleware',
...
# AI Reformat Configuration for problem description reformatting
# Provider: 'gemini', 'openai_compatible', or None (disabled)
AI_REFORMAT_PROVIDER = None
AI_REFORMAT_API_KEY = None
# For OpenAI-compatible APIs (CLI Proxy, OpenRouter, etc.)
AI_REFORMAT_API_URL = None  # e.g., 'https://api.openai.com/v1/chat/completions'
AI_REFORMAT_MODEL = None    # e.g., 'gpt-4o-mini', 'gemini-2.0-flash'

# Backward compatibility: if GEMINI_API_KEY is set, use it as fallback
GEMINI_API_KEY = None
