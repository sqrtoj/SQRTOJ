...
from judge.views import TitledTemplateView, api, blog, comment, contests, language, license, mailgun, organization, \
    preview, problem, problem_manage, ranked_submission, register, resolver, stats, status, submission, tag, tasks, \
...
urlpatterns = [
    ...
    path('problem/<str:problem>', include([
        ...
        path('/translate/<str:language>', problem.ProblemTranslationEdit.as_view(), name='problem_translate'),
        ...
        path('/basic-reformat', problem.basic_reformat_description, name='problem_basic_reformat'),
        path('/ai-reformat', problem.ai_reformat_description, name='problem_ai_reformat'),
    ...
    path('combined-rankings/<str:ranking>/', contests.CombinedContestRankingView.as_view(),
    ...
    path('resolver/<str:contest>', resolver.Resolver.as_view(), name='resolver'),
    path('contest/<str:contest>/resolver/', contests.ContestResolverView.as_view(), name='contest_resolver'),
    path('contest/<str:contest>/resolver/data/', contests.ContestResolverDataView.as_view(),
         name='contest_resolver_data'),
