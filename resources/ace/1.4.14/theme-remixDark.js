define("ace/theme/remixDark", ["require", "exports", "module", "ace/lib/dom"], function (e, t, n) {
    (t.isDark = !1),
      (t.cssClass = "ace-remixDark"),
      (t.cssText = ".ace-remixDark .ace_gutter {\
          background: #2a2c3f;\
          color: #8789a1;\
  ...
  (function () {
    window.require(["ace/theme/remixDark"], function (m) {
